...
contract CharityPlatformTest is ICharityPlatform, FeeManager, ReentrancyGuard {
    /* ======== STATE ======== */
    ...
    function registerOrganization(string calldata name, address wallet) external {
    ...
    function deleteOrganization(string calldata name) external {
